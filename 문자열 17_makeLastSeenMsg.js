...
입출력 예시
1   let output = makeLastSeenMsg('mike', 40);
2   console.log(output); // --> 'mike: 40분 전에 접속함'
3   
4   output = makeLastSeenMsg('mike', 121);
5   console.log(output); // --> 'mike: 2시간 전에 접속함'
6   
7   output = makeLastSeenMsg('mike', 2887);
8   console.log(output); // --> 'mike: 2일 전에 접속함'
