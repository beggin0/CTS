...
이제 우리는 변수를 선언하고, 값을 할당하는 법에 대해서 배웠습니다. 자바스크립트의 모든 값(value)는 각자 타입을 가집니다. 평소에 우리는 무의식적으로 숫자와 문자를 구분하지 않지만, 우리는 이를 무의식적으로 구분할 수 있을 만큼 똑똑합니다. 문맥을 이해할 수 있기 때문이죠. 하지만 컴퓨터는 상황과 문맥을 이해하는 능력이 없습니다.
